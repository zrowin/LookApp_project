      ...
      <div className="app-shell">
        ...
        {outfits.length === 0 ? (
          <div className="text-white/60">
            Brak zapisanych stylizacji. Zapisz stylizację w przymierzalni, klikając serce.
          </div>
        ) : (
          <section className="app-card-grid">
            {outfits.map((o) => (
              ...
              >
                ...
                <div className="flex aspect-[7/5] w-full items-center justify-center overflow-hidden rounded-xl border border-white/5 bg-[#3a3a3a]">
                  {o.thumbnailDataUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img
                      src={o.thumbnailDataUrl}
                      alt={o.name ?? 'Outfit'}
        ...
        {selectedOutfit && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="w-full max-w-2xl rounded-xl border border-white/6 bg-[#252425] p-3 text-white shadow-sm">
              ...
              <div
                className="mb-3 flex aspect-[7/5] w-full items-center justify-center overflow-hidden rounded-xl bg-[#3a3a3a]"
